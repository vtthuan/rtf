...
class ImportCollectionCommand extends ContainerAwareCommand
{
    ...
    protected function configure()
    {
        ...
        ->setDescription('Import collections from CSV file');
    }
    ...
    protected function import(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach($data as $row) {
            ...
            $collection->setEnabled(boolval($row['enabled']));
            $collection->setSlug($row['slug']);
		...
		// Advancing for progress display on console
                ...
                $now = new \DateTime();
                $output->writeln(' of collections imported ... | ' . $now->format('d-m-Y G:i:s'));
    ...
    protected function get(InputInterface $input, OutputInterface $output) 
    {
        ...
        $fileName = 'web/uploads/import/collection.csv';
